...
import com.xc.myblog.util.ConstantOssPropertiesUtils;
...
public class FileServiceImpl implements FileService {
    ...
    public String fileUpload(MultipartFile file) {
        ...
        Region region = new Region(ConstantOssPropertiesUtils.Tencent_place);
        ...
        // 指定文件将要存放的存储桶
        String bucketName = ConstantOssPropertiesUtils.Tencent_storageBucket;
